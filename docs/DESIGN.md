...
> Design notes for **field-service-photo-dispatch-openai-swap-fieldservice-typesc** — a runnable typescript example that A typed service that turns work-order photos into dispatch decisions and embedded technician follow-ups.
...
- **Feature code** — the actual task: photo-to-dispatch-handoff.
